			...
			<?php endif; // true === $et_contact_info_defined ?>
				...
				<?php
					...
					et_show_cart_total();*/
					 $today = date("D"); 
					if($today =='Mon'){
						$data='Mon : 9am - 5pm Open';
					}elseif($today =='Tue'){
						$data='Tue : 9am - 5pm Open';
					}elseif($today =='Wed'){
						$data='Wed : 9am - 5pm Open';
					}elseif($today =='Thu'){
						$data='Thu : 9am - 5pm Open';
					}elseif($today =='Fri'){
						$data='Fri : 9am - 5pm Open';
					}elseif($today =='Sat'){
						$data='Sat : Closed';
					}elseif($today =='Sun'){
						$data='Sun : Closed';
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-243">
	<a data="1" >Sat : Closed, Sunday : Closed </a>
</li>
</ul>
		...
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			...
			?>
				<div class="logo_container">
					...
					<a href="https://shop.morettimilano.com/">
